...
## Phase 3 — Email subscriptions ✅ / in progress 🔴 HIGH PRIORITY
...
- 🔴 **HIGH PRIORITY** — Calendar Export (iCal / Google Calendar): one-click export of PAC events to parents' personal calendars
- 🔴 **HIGH PRIORITY** — Volunteer Sign-up: parents register for events or committees directly on the site; tracked in admin dashboard
